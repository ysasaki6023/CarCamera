...
#print(os.path.exists("video1.mpg"))
cap = cv2.VideoCapture("video1.mpg")
#cap = cv2.VideoCapture("small.mp4")
#cap = skvideo.io.VideoCapture("small.mp4")
#cap = skvideo.io.vreader("video1.mp4")
#cap = cv.CaptureFromFile("video1.mpg")
...
if True:
    ...
    #print(np_img)
    h,w,_ = np_img.shape
    np_img = np_img[:,int(w/2-h/2):int(w/2+h/2)]
